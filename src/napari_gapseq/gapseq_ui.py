...
class Ui_TabWidget(object):
    def setupUi(self, TabWidget):
        ...
        self.label_37 = QtWidgets.QLabel(self.tab_localisations)
        self.label_37.setObjectName("label_37")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.label_37)
        self.localisation_stack_mode = QtWidgets.QComboBox(self.tab_localisations)
        self.localisation_stack_mode.setObjectName("localisation_stack_mode")
        self.localisation_stack_mode.addItem("")
        self.localisation_stack_mode.addItem("")
        self.localisation_stack_mode.addItem("")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.localisation_stack_mode)
        self.label_40 = QtWidgets.QLabel(self.tab_localisations)
        ...
        self.verticalLayout_2.addWidget(self.localisation_import_image)
        ...
        self.localisation_threshold.setProperty("value", 150)
        ...
        self.localisation_frame_averaging.addItem("")
        self.localisation_frame_averaging.addItem("")
        self.formLayout_6.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.localisation_frame_averaging)
        ...
        spacerItem9 = QtWidgets.QSpacerItem(341, 37, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
    ...
    def retranslateUi(self, TabWidget):
        ...
        self.label_4.setText(_translate("TabWidget", "Import Localisation Image/File"))
        ...
        self.label_37.setText(_translate("TabWidget", "Frame Stacking Mode"))
        self.localisation_stack_mode.setItemText(0, _translate("TabWidget", "Mean"))
        self.localisation_stack_mode.setItemText(1, _translate("TabWidget", "Max"))
        self.localisation_stack_mode.setItemText(2, _translate("TabWidget", "Standard Deviation"))
        self.label_40.setText(_translate("TabWidget", "Channel"))
        ...
        self.localisation_threshold_label.setText(_translate("TabWidget", "150"))
        ...
        self.plot_metric.setItemText(2, _translate("TabWidget", "Bounding Box Range"))
        self.plot_metric.setItemText(3, _translate("TabWidget", "Gaussian Height"))
        self.plot_metric.setItemText(4, _translate("TabWidget", "Gaussain Width"))
        ...
        self.fit_plot_metric.setItemText(2, _translate("TabWidget", "Bounding Box Range"))
        self.fit_plot_metric.setItemText(3, _translate("TabWidget", "Gaussian Height"))
        self.fit_plot_metric.setItemText(4, _translate("TabWidget", "Gaussain Width"))
