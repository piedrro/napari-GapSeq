...
class Ui_TabWidget(object):
    def setupUi(self, TabWidget):
        ...
        self.label_22 = QtWidgets.QLabel(self.tab_localisations)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.plot_compute = QtWidgets.QPushButton(self.tab_localisations)
        self.plot_compute.setObjectName("plot_compute")
        self.verticalLayout_2.addWidget(self.plot_compute)
        self.plot_compute_progress = QtWidgets.QProgressBar(self.tab_localisations)
        ...
        self.verticalLayout_2.addWidget(self.plot_compute_progress)
    ...
    def retranslateUi(self, TabWidget):
        ...
        self.label_35.setText(_translate("TabWidget", "Change Point Detection Settings"))
        self.label_36.setText(_translate("TabWidget", "Change Point Detection Mode"))
        self.fit_cpd_mode.setItemText(0, _translate("TabWidget", "Pruned Exact Linear Time (PELT)"))
        self.fit_cpd_mode.setItemText(1, _translate("TabWidget", "Binary Segmentation"))
        self.fit_cpd_mode.setItemText(2, _translate("TabWidget", "Window Based"))
        self.fit_cpd_mode.setItemText(3, _translate("TabWidget", "Bottom Up"))
        self.fit_cpd_mode.setItemText(4, _translate("TabWidget", "Dynamic Programming"))
        self.fit_cpd_model_label.setText(_translate("TabWidget", "Model"))
        self.fit_cpd_model.setItemText(0, _translate("TabWidget", "l2"))
        self.fit_cpd_model.setItemText(1, _translate("TabWidget", "l1"))
        self.fit_cpd_model.setItemText(2, _translate("TabWidget", "rbf"))
        self.fit_cpd_penalty_label.setText(_translate("TabWidget", "Penalty"))
        self.fit_cpd_min_size_label.setToolTip(_translate("TabWidget", "Minimum segment length"))
        ...
        self.fit_active.setText(_translate("TabWidget", "Detect Change Points (Acitve Image)"))
        TabWidget.setTabText(TabWidget.indexOf(self.tab_fit), _translate("TabWidget", "Fit"))
